...
let selectedChallengeId = null; // 도전 선택 시 세팅
let selectedCertId = null;      // 인증글 카드 클릭 시 세팅
...
window.renderPostAdd = function() {
  ...
  // 3. 인증글 카드 클릭 (challenge-detail-right와 동일 구조)
  ...
  if (submitBtn) {
    submitBtn.onclick = function() {
      ...
      posts.unshift({
        ...
        challengeTitle: challenge ? challenge.title : "",    // ← ★ 도전명 저장!
